export default function Brokerage(){
    return(
        <div className="container">
            <div className="row col-11 m-auto mt-5 mb-5">
                <h3 className="fs-4">Charges explained</h3>
                <div className="col-lg-6 col-sm-10">
                    <h4 className="pricing-heading">Securities/Commodities transaction tax</h4>
                    <p className="pricing-text">
                        Tax by the government when transacting on the exchanges. Charged as above on both buy and sell 
                        sides when trading equity delivery. Charged only on selling side when trading intraday or on F&O.
                    </p>
                    <p className="pricing-text">
                        When trading at Zerodha, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.
                    </p>

                    <h4 className="pricing-heading">Transaction/Turnover Charges</h4>
                    <p className="pricing-text">
                    ...
                    <h4 className="pricing-heading">NRI brokerage charges</h4>
                    <p className="pricing-text">
                        <ul>
                    ...
                    <h4 className="pricing-heading">Account with debit balance</h4>
                    <p className="pricing-text">
                        If the account is in debit balance, any order placed will be charged ₹40 per executed order instead of ₹20 per executed order.
                    </p>

                    <h4 className="pricing-heading">Charges for Investor's Protection Fund Trust (IPFT) by NSE</h4>
                    <p className="pricing-text">
                        <ul>
                    ...
                    <h4 className="pricing-heading">Margin Trading Facility (MTF)</h4>
                    <p className="pricing-text">
                        <ul>
                ...
                <div className="col-lg-6 col-sm-10">
                    ...
                    <h4 className="pricing-heading">Pledging charges</h4>
                    <p className="pricing-text">
                       ₹30 + GST per pledge request per ISIN.
                    </p>

                    <h4 className="pricing-heading">AMC (Account maintenance charges)</h4>
                    <p className="pricing-text">
                    ...
                    <h4 className="pricing-heading">Corporate action order charges</h4>
                    <p className="pricing-text">
                       ₹20 plus GST will be charged for OFS / buyback / takeover / delisting orders placed through Console. 
                    </p>

                    <h4 className="pricing-heading">Off-market transfer charges</h4>
                    <p className="pricing-text">
                       ₹25 per transaction.
                    </p>

                    <h4 className="pricing-heading">Physical CMR request</h4>
                    <p className="pricing-text">
                       First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for subsequent requests.
                    </p>

                    <h4 className="pricing-heading">Payment gateway charges</h4>
                    <p className="pricing-text">
                       ₹9 + GST (Not levied on transfers done via UPI)
                    </p>

                    <h4 className="pricing-heading">Delayed Payment Charges</h4>
                    <p className="pricing-text">
                       Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. Learn more.
                    </p>

                    <h4 className="pricing-heading">Trading using 3-in-1 account with block functionality</h4>
                    <p className="pricing-text">
                        <ul>
                            <li><b className="fw-medium">Delivery & MTF Brokerage:</b> 0.5% per executed order.</li>
                            <li><b className="fw-medium">Intraday Brokerage:</b> 0.05% per executed order.</li>
                        </ul>
                    </p>
                </div>

                <h4 className="pricing-heading">Disclaimer</h4>
                <p className="pricing-text">
                    ...
                    charged ₹20 per contract note plus courier charges. Brokerage will not exceed the rates specified by SEBI and the exchanges. 
                    All statutory and regulatory charges will be levied at actuals. Brokerage is also charged on expired, exercised, and assigned options contracts. 
                    Free investments are available only for our retail individual clients. Companies, Partnerships, Trusts, and HUFs need to pay 0.1% or ₹20 (whichever is less) as delivery brokerage. 
